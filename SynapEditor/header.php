...
<link href='/gw/SynapEditor/synapeditor.min.css' rel='stylesheet' type='text/css'>
<script src='/gw/SynapEditor/synapeditor.config.js'></script>
<script src='/gw/SynapEditor/synapeditor.min.js'></script>
<!-- 플러그인 -->

<!-- ShapEditor plugin include -->
<script src="/gw/SynapEditor/plugins/shapeEditor/shapeEditor.min.js"></script>
<link rel="stylesheet" href="/gw/SynapEditor/plugins/shapeEditor/shapeEditor.min.css">
 
<!-- SEShapeManager module include -->
<script src="/gw/SynapEditor/externals/SEShapeManager/SEShapeManager.min.js"></script>
<!-- <script src='/gw/SynapEditor/plugins/characterPicker/characterPicker.min.css'></script> -->
<script src='/gw/SynapEditor/plugins/characterPicker/characterPicker.min.js'></script>
<script src="/gw/SynapEditor/externals/SEDocModelParser/SEDocModelParser.min.js"></script>
<script type="text/javascript" src="/gw/SynapEditor/externals/formulaParser/formula-parser.min.js"></script>
<?php
if($isLogin) {
?>
<style>
