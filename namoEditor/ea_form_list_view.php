...
<!-- <script type="text/javascript" src="/gw/namoEditor/js/namo_scripteditor.js"></script>
<script src="/gw/namoEditor/lib/jquery-1.7.2.min.js"></script> -->
<script>
var CrossEditor = new NamoSE("test");
CrossEditor.params.ParentEditor = document.getElementById("editorContent");
CrossEditor.SetUISize("100%","300");
...
//         });
//     });
    // $("#editorContent").load("/gw/namoEditor/index.html");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-2">
                    ...
                    <div id="editorContent" style="width:100%; height:21.5rem"></div>
                    <!-- <iframe src="/gw/namoEditor/index.html" id="frameEditor" frameborder="0" width="100%" style="height:21.5rem"></iframe> -->
