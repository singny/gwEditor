...
<link rel="stylesheet" type="text/css" href="/gw/DevExtreme/css/dx.light.css" />
<script src="/gw/DevExtreme/js/dx-quill.min.js"></script>
<script src="/gw/DevExtreme/js/dx.all.js"></script>
<?php
if($isLogin) {
?>
<style>
