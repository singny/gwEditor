...
//             }
            ...
            if ($("#appbox").val() == "rcptray") {
                html += '<div class="col-lg-4 mb-2 search-inline">';
                // html += '<div class="search-inline">';
                //문서종류
...
//                 divCol.eq(1).removeClass("col-lg-5").addClass("col-lg-3");
            ...
            if ($.inArray($("#appbox").val(), ["mytray", "extray", "outtray", "mantray", "workmantray"]) > -1) {
                ...
                html += '</select>';
                //결재상태
                html += '<label class="labelMargin">결재상태</label>';
        ...
        complete: function() {
            if ($("#parameters").val() != "") {
                ...
                if (paramList["formId"] === undefined || paramList["formId"] == "") {
                    ...
                    $("#ddlDocType").val(paramList["formId"]);
                    if(paramList["docId"] && paramList["formId"]) {
...
//             $("#modalDetailAppDoc").data("processing", false);
    ...
    $("#modalDetailAppDoc").on('hide.bs.modal', function() {
        ...
        if ($.inArray($("#appbox").val(), ["intray", "rcptray"]) > -1) {
            //읽음 확인
			if($("#ddlReadKind").val() && $("#ddlReadKind").val() == "0") // <> -999 and <> 1 일때만 실행
			{
				onConditionChange();
			}
        }
...
//         forcePasteAsPlainText : true,
        contentsCss: 'body{font-family: "Malgun Gothic",Arial,sans-serif;font-size: 14px;width:630px;margin: 20px;line-height:1.5;}table{border-collapse: collapse;}',
        on: {
...
//         removeButtons: 'Styles,Format,Anchor',
        ...
        filebrowserImageUploadUrl: '/gw/cm/cm_file_upload.php?moduleName=EA&type=Images',
//         forcePasteAsPlainText : true,
        contentsCss: 'body{font-family: "Malgun Gothic",Arial,sans-serif;font-size: 14px;margin: 20px;width: 630px;line-height:1.5;}table{border-collapse: collapse;}',
        on: {
            instanceReady: function(evt) {
...
//                     $("#txtRecipientNms").closest("div").append(html);
                ...
                $("#txtDirectorNms").text(essentialNmStr);
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div id="divBtnList" class="col-md">
                            <div class="d-flex justify-content-end mr-3">
                                <button type="button" class="btn btn-primary mr-2" id="btnPrint" onclick="printAppDoc()">인쇄</button>
            ...
            <div class="modal-body">
                ...
                <div class="mb-2" style="border: 0.1rem solid #999;overflow-x: auto;">
                    <div class="row m-0 notExpansion">
                        <div id="divDetailContent" class="col d-flex justify-content-md-center p-4">
                            <div class="detailContent" class="py-2" style="min-height: 28rem;min-width:47rem;word-wrap: break-word;">
                                <div class="mb-4">
                                    <h4 id="txtDF10" class="txtDF10" style="font-weight: bold;"></h4>
                                </div>
                                <div id="divDF11"></div>
                            </div>
                        </div>
                    </div>
                    <h4 class="txtDF20 d-flex justify-content-center" style="font-weight: bold;"></h4>
                </div>
                <div class="row mb-2">
                ...
                <div class="page-number" style="display:none"></div>
                <hr class="notPrint" />
                ...
                <div class="recipientAll" style="display:none;"></div>
            </div>
