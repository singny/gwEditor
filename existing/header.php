...
//                 htmlMobile += '<span class="fa-stack fa-3x has-badge" data-count="8">';
                ...
                htmlMobile += '<i class="fa fa-' + iconList[obj.menuCd] + ' fa-stack-1x fa-inverse" style="font-size:x-large"></i>';
                htmlMobile += '</span>';
                htmlMobile += '<br />';
                htmlMobile += '<div>';
...
<?php
// if(in_array($isLogin, array(9870, 9946))) {
    require_once ("wo/to_do_sign_list_view.php");
// }
}
?>
